...
19. 需要整理项目级 `AGENTS.md`，把当前仓库真实执行的发布/提交规则收口成更清晰的结构，并与最新的 NanoSpec 任务跟踪规则保持一致。
20. 需要发布新版本，并把更新后的 `nanospec` skill 同步到 `~/.codex/skills/nanospec`。
...
- 项目级规则、发版产物和用户本地安装的 skill 版本保持一致。
